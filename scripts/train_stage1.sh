...
BASE_MODEL="/root/autodl-fs/checkpoints/Qwen-Qwen3-VL-8B-Instruct"
TRAIN_DATA_PATH="/root/autodl-tmp/rryisthebest-rank_zephyr_training_data_alpha/rank_zephyr_training_data_alpha.jsonl"
OUTPUT_DIR="/root/autodl-fs/models/ziprerank_stage1"
echo "========================================"
